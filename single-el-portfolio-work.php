	...
	<?php
		...
		<?php while (have_rows('single_works_tab')) : the_row(); ?>
			...
			<div class="tab-content">
				<div id="tab-takeaway" data-tab-content class="active">
					<p><?php the_sub_field('takeaway'); ?></p>
				</div>
				<div id="tab-key_components" data-tab-content>
					<p><?php the_sub_field('key_components'); ?></p>
				</div>
				<div id="tab-technical_skills" data-tab-content>
					<p><?php the_sub_field('technical_skills'); ?></p>
				</div>
			</div>
		<?php endwhile; ?>
...
<a href="https://eriklarsen.ca/works/"><button class="cta-works">Back To Works</button></a>
</div>
</main>
